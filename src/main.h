...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 LMR
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 LMR mininput
/** No amount larger than this (in lemurcoin) is valid */
...
public:
    ...
    */
    ...
    /** Amount of lemurcoins coming in to this transaction
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 288 / 250; //1.152 (288 blocks per day)
    }
