...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LemurCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"lemurcoin.com", "188.226.135.189"}, //First Seed Node
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. LemurCoin is probably already running."), addrBind.ToString().c_str());
        else
